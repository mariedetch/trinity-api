...
export class StatsController {
  ...
  @ApiOperation({
    summary:
      "Récupère le chiffre d'affaire, le bénéfice et le total de commandes : hebdomadaire, mensuel et annuel",
  })
  ...
  @ApiOperation({
    summary: 'Récupère les 6 villes qui ont le plus de clients',
  })
