...
export class StatsController {
  ...
  @ApiOperation({ summary: "Récupère le nombre de commandes pour chaque mois sur les 12 derniers mois"})
  ...
  @ApiOperation({ summary: "Récupère le chiffre d'affaire pour chaque mois sur les 12 derniers mois"})
  ...
  @ApiOperation({ summary: "Récupère le chiffre d'affaire hebdomadaire, mensuel et annuel"})
  ...
  @ApiOperation({ summary: "Récupère le bénéfice hebdomadaire, mensuel et annuel"})
  ...
  @ApiOperation({ summary: "Récupère le nombre de nouveaux clients pour chaque mois sur les 12 derniers mois"})
  ...
  @ApiOperation({ summary: "Récupère les 6 categories de produits les plus vendus"})
